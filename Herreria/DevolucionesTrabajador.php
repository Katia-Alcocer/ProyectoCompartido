...
<head>
    ...
    <title>Devoluciones - Herrería UG</title>
    ...
    <section class="centro">
        ...
        <nav class="menu-lateral">
            <div class="menu-header">
                ...
                <h2 class="menu-titulo">Abarrotes Guzman</h2>
            </div>
            <ul class="menu-list">
                <li><a href="InicioTrabajadores.php"><img src="Imagenes/Casa.png" alt=""> Inicio</a></li>
                <li><a href="DevolucionesTrabajador.php"><img src="Imagenes/Devolucion.png" alt=""> Hacer Devolución</a></li>
                <li><a href="PedidosAceptados.php"><img src="Imagenes/Pedido.png" alt=""> Pedidos</a></li>
